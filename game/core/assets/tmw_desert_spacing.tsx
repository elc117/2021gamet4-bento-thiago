...
<tileset version="1.5" tiledversion="1.7.1" name="tmw_desert_spacing" tilewidth="32" tileheight="32" spacing="1" margin="1" tilecount="48" columns="8">
 <image source="./tmw_desert_spacing-2.png" width="265" height="199"/>
 <wangsets>
  <wangset name="brick" type="corner" tile="-1">
   <wangcolor name="Brick" color="#ff0000" tile="9" probability="1"/>
   <wangcolor name="Stone" color="#00ff00" tile="33" probability="1"/>
